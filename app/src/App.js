...
class App extends Component {
    ...
    tableElements = document.getElementById("myTable");


    async componentDidMount() {
        const response = await fetch(
          "https://m1hz7vnaql.execute-api.ap-south-1.amazonaws.com/dev"
        );
    ...
    render() { 
        ...
        allinvoices.map( invoice => 
            <tr key={invoice.id}>
                ...
                <td><Button className="btn btn-lg btn-info" onClick={event =>  window.location.href=invoice.link} > <FontAwesomeIcon icon={faImage} /> Image </Button></td>
            </tr>
        )
            ...
            <div className="container border border-secondary rouded center">
                ...
                <div className="row">
                        <div className=".col-xs-12 center text-center">
                            <Table dark responsive striped bordered hover id="myTable">
                                <thead>
                                    <tr>
                                        <th >Vendor</th>
                                        <th>Amount</th>
